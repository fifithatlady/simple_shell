#include "shell.h"
/**
 * _which - a function that searches variable commands in the environment
 * @command: the variable command to search
 * @fullpath: the full path of the command to find
 * @path: the variable full path
 * Return: it returns full path
 */
